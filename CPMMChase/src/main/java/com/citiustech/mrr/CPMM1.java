...
public class CPMM1 implements java.io.Serializable {
	...
	@javax.persistence.Column(name = "CRTD_DT")
	private Date createdDate;

	@javax.persistence.Column(name = "CRTD_BY")
	private String createdBy;

	@javax.persistence.Column(name = "MDFD_DT")
	private Date modifiedDate;

	@javax.persistence.Column(name = "MDFD_BY")
	...
	public CPMM1(java.lang.Long cpmmId, java.lang.String cpmmChseCd,
			...
			java.util.Date chseDueDt, java.lang.Long parentProcessID,
			boolean manualChase, java.lang.String defaultRule,
			java.lang.String prefMoc, java.util.Date assignedDate,
			java.util.Date createdDate, java.lang.String createdBy,
			java.util.Date modifiedDate, java.lang.String modifiedBy) {
		this.cpmmId = cpmmId;
		this.cpmmChseCd = cpmmChseCd;
		this.cmmId = cmmId;
		this.cmmChaseCode = cmmChaseCode;
